...
if (isset($convention)) {
    ...
    echo "<h1> Convention de " . htmlspecialchars($convention->getNomAlternantEtu()) . " " . htmlspecialchars($convention->getPrenomAlternantEtu()) . "</h1>";
    echo "<div class='boutonsGeneral'>
            <div> <a href='controleurFrontal.php?controleur=convention&action=afficherMAJConvention&numConvention=".$convention->getId()."'> Modifier Convention </a> </div>
           </div>";
    echo "<hr/>";
    ...
    echo "<p class='case'>" . $convention->getId() . "</p>";
    echo "</div>";
    echo "</div>";
    ...
    if($entreprise != null){
        ...
        echo "<div class='supcase'>";
        echo "<p class='case'>" . $entreprise->getEtablissement() . "</p>";
        echo "</div>";
        echo "</div>";
        echo "</a>";
    }else{
    ...
    if($entreprise != null){
        ...
        echo "<h3> Étudiant </h3>";
        echo "<div class='supcase'>";
        echo "<p class='case'>" . $convention->getNomAlternantEtu()  . " " . $convention->getPrenomAlternantEtu()." </p>";
        echo "</div>";
        echo "</div>";
        echo "</div>";
    }else{
        ...
        echo "<div class='supcase'>";
        echo "<p class='case'>" . $convention->getNomAlternantEtu() . "</p>";
        echo "</div>";
        echo "</div>";
        ...
        echo "<div class='supcase'>";
        echo "<p class='case'>" . $convention->getPrenomAlternantEtu() . "</p>";
        echo "</div>";
        echo "</div>";
        ...
        echo "<div class='supcase'>";
        echo "<p class='case'>" . $convention->getEmail1() . "</p>";
        echo "</div>";
        echo "</div>";
        echo "</div>";
    }
    ...
    echo "<h3> Ville </h3>";
    echo "<div class='supcase'>";
    echo "<p class='case'>" . $convention->getAdresseContact() . "</p>";
    echo "</div>";
    echo "</div>";
    ...
    */
    ...
    echo "<h3> Année </h3>";
    echo "<div class='supcase'>";
    echo "<p class='case'>" . $convention->getAnneeDebut()." - ". $convention->getAnneeFin() . "</p>";
    echo "</div>";
    echo "</div>";
    echo "</div>";
    ...
    echo "<div class='supcase'>";
    echo "<p class='case'>" . $convention->getDateDebutContrat() . "</p>";
    echo "</div>";
    echo "</div>";
    ...
    echo "<div class='supcase'>";
    echo "<p class='case'>" . $convention->getDateFinContrat() . "</p>";
    echo "</div>";
    echo "</div>";
    ...
    */
    ...
    echo "<div class='case'>";
    echo "<h3> Durée de l'alternance </h3>";
    echo "<div class='supcase'>";
    echo "<p class='case'>" . $convention->getDureeContrat() . "</p>";
    echo "</div>";
    echo "</div>";
    echo '</div>';
    ...
    echo "<div class='detailLigne'>";
    echo "<div class='case'>";
    echo "<h3> Missions du Projet </h3>";
    echo "<div class='supcase'>";
    echo "<p class='case'>" . $convention->getMissionSaisie() . "</p>";
    echo "</div>";
    echo "</div>";
    echo "</div>";
} else {
