        ...
        <form method="post" name="inscription" action="controleurFrontal.php?action=MAJEtudiant">
            <div class="user-details">
                ...
                <div class="input-box">
                    ...
                    <input type="text" value=<?php echo $etudiant->getPromotion() ?> name="promotion" pattern="[0-3]{1}" maxlength="1" required <?php if(!\App\Lib\ConnexionUtilisateur::estSecretariat()){ echo 'readonly'; } ?>>
                </div>
                <div class="input-box">
                    <span class="details">Parcours</span>
                    <input type="text" value=<?php echo $etudiant->getParcours() ?> name="parcours" maxlength="5" required <?php if(!\App\Lib\ConnexionUtilisateur::estSecretariat()){ echo 'readonly'; } ?>>
                </div>
                <div class="input-box">
                    <span class="details">Groupe</span>
                    <input type="text" value=<?php echo $etudiant->getGroupe() ?> name="groupe" maxlength="2" required <?php if(!\App\Lib\ConnexionUtilisateur::estSecretariat()){ echo 'readonly'; } ?>>
                </div>
                <div class="input-box">
                    <span class="details">Nom</span>
                    <input type="text" value=<?php echo $etudiant->getNom() ?> name="nom"  maxlength="50" required <?php if(!\App\Lib\ConnexionUtilisateur::estSecretariat()){ echo 'readonly'; } ?>>
                </div>
                <div class="input-box">
                    <span class="details">Prénom</span>
                    <input type="text" name="prenom" maxlength="50" value=<?php echo $etudiant->getPrenom() ?>  required <?php if(!\App\Lib\ConnexionUtilisateur::estSecretariat()){ echo 'readonly'; } ?> >
                </div>
                <div class="input-box">
                    <span class="details">Date de Naissance </span>
                    <input type="date" value=<?php echo $etudiant->getDateDeNaissance() ?> name="date_de_naissance" required <?php if(!\App\Lib\ConnexionUtilisateur::estSecretariat()){ echo 'readonly'; } ?>>
                </div>
                <div class="input-box">
