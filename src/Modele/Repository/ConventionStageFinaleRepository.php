...
class ConventionStageFinaleRepository extends AbstractRepository
{
    ...
    public function nbreConventionValidePedagogique(){
        $sql = "SELECT COUNT(numConvention) FROM ConventionStageFinale WHERE conventionValidePedagogique = 'Oui'";
    ...
    public function nbreConventionNonValidePedagogique(){
        $sql = "SELECT COUNT(numConvention) FROM ConventionStageFinale WHERE conventionValidePedagogique = 'Non'";
        $pdoStatement = ConnexionBaseDeDonnee::getPdo()->query($sql);
    ...
    public static function validerConventionPedagogique(ConventionStage $conventionStage) : void {
        ...
        $sql = "UPDATE ConventionStageFinale SET conventionValidePedagogique = :conventionValidePedagogiqueTag WHERE numConvention = :numConventionTag";
    ...
    public function nbreConventionValide(){
        $sql = "SELECT COUNT(numConvention) FROM ConventionStageFinale WHERE conventionValide = 'Oui'";
        $pdoStatement = ConnexionBaseDeDonnee::getPdo()->query($sql);
    ...
    public function nbreConventionNonValide(){
        $sql = "SELECT COUNT(numConvention) FROM ConventionStageFinale WHERE conventionValide = 'Non'";
        $pdoStatement = ConnexionBaseDeDonnee::getPdo()->query($sql);
    ...
    public function recupererDepuisNumEtudiant($numEtudiant) : ?ConventionStage {
        $sql = "SELECT * FROM ConventionStageFinale WHERE numEtudiant = :numEtudiantTag";
        $pdoStatement = ConnexionBaseDeDonnee::getPdo()->prepare($sql);
